...
public class MongoUtil {
    ...
    static String _host = null;
    static Integer _port = null;
    static String _user = null;
    static String _pwd = null;
    public static String _db = null;
    
   public static void config(String host, int port, String user, String pwd, String db) {
	   _host = host;
	   _port = port;
	   _user = user;
	   _pwd = pwd;
   ...
   static void loadConfig() {
	   _host = ZSystemConfig.getProperty("mdb_host");
	   if (ZSystemConfig.getProperty("mdb_port") != null) {
		   _port = Integer.valueOf(ZSystemConfig.getProperty("mdb_port"));
	   }
	   _user = ZSystemConfig.getProperty("mdb_user");
	   _pwd = ZSystemConfig.getProperty("mdb_pwd");
	   _db = ZSystemConfig.getProperty("mdb_dbname");
   }
   ...
   public static MongoDatabase getDB(String dbName) {
       if (dbName != null && !"".equals(dbName)) {
           MongoDatabase database = getInstance().getDatabase(dbName);
           return database;
       }
       return null;
   }
   ...
   public static MongoCollection<Document> getCollection(String dbName, String collName) {
       ...
       MongoCollection<Document> collection = getInstance().getDatabase(dbName).getCollection(collName);
       return collection;
   }
   ...
   public static MongoIterable<String> getAllDBNames() {
       MongoIterable<String> s = getInstance().listDatabaseNames();
       return s;
   }
