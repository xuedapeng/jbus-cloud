...
public class GetUiconfigsOfPidLogic extends BaseZLogic {

	@Override
	protected boolean execute(ZLogicParam logicParam, ZSimpleJsonObject res, EntityManager em) throws Exception {

		GetUiconfigsOfPidLogicParam myParam = (GetUiconfigsOfPidLogicParam)logicParam;
	...
	private List<Object> getCover(String cover) {
		...
		Map<String, Map<String, String>> ptnMap = null;
		for(Object E: coverList) {

			Map<String, Object> m = (Map<String, Object>)E;
			if("valuePtn".equals(m.get("type"))) {
				ptnMap = (Map<String, Map<String, String>>) m.get("pattern");
				break;
			}
	...
	@SuppressWarnings("unchecked")
	private void fillValuePtn(Map<String, Object> datDefine, Map<String, Map<String, String>> ptnMap) {
		if (!datDefine.containsKey("valuePtn")) {
			return;
		}
		
		Map<String, String> valuePtn = (Map<String, String>) datDefine.get("valuePtn");
		if(!valuePtn.containsKey("refptn")) {
			return;
		}
		
		String refptn = valuePtn.get("refptn");
		if (ptnMap == null || !ptnMap.containsKey(refptn)) {
			// todo：应该报警告
			return;
		}
		
		datDefine.put("valuePtn", ptnMap.get(refptn));
