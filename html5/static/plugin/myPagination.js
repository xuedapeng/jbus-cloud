function Page(_ref){
  ...
  if(dataTotal>0&&pageTotal>0){this.init();}else{console.error("总页数或者总数据参数不对")}};
  ...
  Page.prototype={
    ...
    firstPage:function firstPage(){
      var that=this;
      var li=document.createElement('li');
      li.innerHTML='<<';this.ul.appendChild(li);
      li.onclick=function(){
        var val=parseInt(1);
        that.curPage=val;
        that.getPage(that.curPage);
    ...
    showPageTotal:function showPageTotal(){
      ...
      li.innerHTML='共'+that.dataTotal+'条/' + that.pageTotal + '页';
      li.className='totalPage';
      this.ul.appendChild(li);
      // var li2=document.createElement('li');
      // li2.innerHTML=''+that.pageAmount+'条/页';
      // li2.className='totalPage';
      // this.ul.appendChild(li2);
      // var li3=document.createElement('li');
      // li3.innerHTML='合计'+that.dataTotal+'条';
